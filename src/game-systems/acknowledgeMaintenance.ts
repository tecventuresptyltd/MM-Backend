 ...
 */
export const acknowledgeMaintenanceRewards = onCall(callableOptions({ minInstances: getMinInstances(false), memory: "512MiB", cpu: 1, concurrency: 80 }, true), async (rawRequest) => {
