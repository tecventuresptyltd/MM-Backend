...
export const ensureGuestSession = onCall(
  callableOptions({ enforceAppCheck: false, minInstances: getMinInstances(true), memory: "512MiB", cpu: 1, concurrency: 80, invoker: "public" }, true),
  async (request) => {
